...
export const MAX_NUMBER_LIVE_PROPOSALS = 100; // Maximal number of proposals allowed to exist simultaneously.
...
export const MAX_NUM_RECORDED_VOTES = 100;
...
export const CREATION_FAILED_TOO_MANY_LIVE = 0; // Event error code for failed proposal creation when the limit of live proposals is reached.
