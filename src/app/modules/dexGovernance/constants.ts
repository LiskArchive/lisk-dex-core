...
export const FEE_PROPOSAL_CREATION = BigInt(500000000); // * 10^8|Amount of fee to be paid for proposal creation in DEX native tokens.
export const MINIMAL_BALANCE_PROPOSE = BigInt(100000000); // * 10^8|Minimal amount of DEX native tokens an account should have to create a proposal (including PoS locked tokens).
