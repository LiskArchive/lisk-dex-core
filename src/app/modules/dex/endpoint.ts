...
import { getAllPositionIDsInPoolRequestSchema, getCurrentSqrtPriceRequestSchema, getLSKPriceRequestSchema, getPoolRequestSchema, getPositionIndexRequestSchema, getPositionRequestSchema, getTickWithPoolIdAndTickValueRequestSchema, getTickWithTickIdRequestSchema, getTVLRequestSchema } from './schemas';
...
public getAllPositionIDsInPool(methodContext: ModuleEndpointContext): Buffer[] {
	...
	public async getTickWithTickId(
		...
		validator.validate<{ tickIDs: Buffer }>(
