...
import { getAllPositionIDsInPoolRequestSchema, getCurrentSqrtPriceRequestSchema, getLSKPriceRequestSchema, getPoolIDFromTickIDRequestSchema, getPoolRequestSchema, getPositionIndexRequestSchema, getPositionRequestSchema, getTickWithPoolIdAndTickValueRequestSchema, getTickWithTickIdRequestSchema, getTVLRequestSchema } from './schemas';
...
public getAllPositionIDsInPool(methodContext: ModuleEndpointContext): Buffer[] {
	...
	public getPoolIDFromTickID(methodContext) {
		validator.validate<{ tickID: Buffer; }>(
