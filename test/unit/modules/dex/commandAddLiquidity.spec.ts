...
import { AddLiquidityCommand } from '../../../../src/app/modules/dex/commands/addLiquidity';
import { addLiquidityParamsSchema } from '../../../../src/app/modules/dex/schemas';
...
describe('dex:command:addLiquidity', () => {
	...
	beforeEach(() => {
		command = new AddLiquidityCommand(dexModule.stores, dexModule.events);
		// interopAPI = {
	...
	describe('verify', () => {
		it('should be successful when all the parameters are correct', async () => {
			const context = createTransactionContext({
				transaction: new Transaction({
					...
					params: codec.encode(addLiquidityParamsSchema, {
			...
			const result = await command.verify(context.createCommandVerifyContext(addLiquidityParamsSchema));
		...
		it('should fail on invalid amounts', async () => {
			const context = createTransactionContext({
				transaction: new Transaction({
					module: 'dex',
					command: 'addLiquidity',
